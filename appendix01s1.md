...
<a name="fn_124"></a>[`213:1`](#fr_124) The name **Tuàn** (Chinese: [彖](https://en.wikipedia.org/wiki/I_Ching#cite_note-16)), and the meaning of the character so-called, are sufficiently established. The Tuàn are [king Wén](https://en.wikipedia.org/wiki/King_Wen_of_Zhou)'s explanations of the entire hexagrams. It seems impossible now to [p. 214](#p-214) ascertain how the character arose, and how it was named [**Tuàn**](https://en.wikipedia.org/wiki/I_Ching#cite_note-16). The treatise on the Tuàn is ascribed to Confucius.

<a name="fn_125"></a>[`214:I`](#fr_125) The hexagram [**Qián ䷀**](./e4b9beqian.md) is made up of six undivided lines, or of the trigram [**Qián ䷀**](./e4b9beqian.md), [Fúxī](https://en.wikipedia.org/wiki/Fuxi)'s symbol for heaven, repeated. The Tuàn does not dwell upon this, but starts, in its exposition, from the word 'heaven,' supposing that the hexagram represented all the meaning which had ever been intended by that term. In paragraphs 1, 2, 4 the four attributes in Wén's Text (2 being occupied with the second, though it is not expressly named) are illustrated by the phenomena taking place in the physical world.
...
2. 'A strong line has come and got the central place:' -- this sentence has given rise to a doctrine about the changes of trigrams and hexagrams, which has obscured more than anything else the interpretation of the `I Ching`. Where has the strong second line come from? From a hundred critics we receive the answer, -- 'From **Tun** (**䷋** or [**Pǐ ䷋**](e590a6pi.md)).' The reader will see that if the second and third lines of the lower trigram there be made to change places, there results **䷅** or [**Sòng ䷅**](e8aebcsong.md). The doctrine of changing the figures by the manipulation of the stalks did spring up between the time of Wén and his son and that of the composition of the Appendixes; but there is no trace of it in the real Text of the `I Ching`; and it renders any scheme for the interpretation of the figures impossible. The [p. 220](#p-220) editors of the imperial `I Ching` allow this, and on the present passage discard the doctrine entirely, referring to the language of the Tuàn on hexagrams 11 and 12 as fatal to it. See the notes there, and the Introduction, [pp. 11-16](https://sacred-texts.com/ich/icintr02.htm#page_11). 'A strong line has come' is to be taken as equivalent simply to a strong line is there.'
...
Paragraph 2 has been sufficiently explained on the Tuàn itself.
