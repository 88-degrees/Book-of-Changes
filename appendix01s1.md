...
2. 'A strong line has come and got the central place:' -- this sentence has given rise to a doctrine about the changes of trigrams and hexagrams, which has obscured more than anything else the interpretation of the [Yì Jīng](https://ctext.org/book-of-changes). Where has the strong second line come from? From a hundred critics we receive the answer, -- 'From [**䷠ Dùn**](e981afdun.md).' The reader will see that if the second and third lines of the lower trigram **☶** there be made to change places, there results [**䷅ Sòng**](e8aebcsong.md). The doctrine of changing the figures by the manipulation of the stalks did spring up between the time of Wén and his son and that of the composition of the Appendixes; but there is no trace of it in the real Text of the [Yì Jīng](https://ctext.org/book-of-changes); and it renders any scheme for the interpretation of the figures impossible. The editors of the imperial [Yì Jīng](https://ctext.org/book-of-changes) [allow this](#p-220), and on the present passage discard the doctrine entirely, referring to the language of the [Tuàn](https://ctext.org/book-of-changes/tuan-zhuan) on [hexagrams 11 ䷊](e6b3b0tai.md) and [12 ䷋](e590a6pi.md) as fatal to it. See the notes there, and the Introduction, [Four Symbols](https://en.wikipedia.org/wiki/Four_Symbols). 'A strong line has come' is to be taken as equivalent simply to a strong line is there.' What 'the great man sets a value on being the due mean and the correct place,' his decision in any matter of contention is sure to be right.
