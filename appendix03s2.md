...
In paragraph 46 the writer passes from the work of [Fú-xī](https://en.wikipedia.org/wiki/Fuxi) to that of [king Wén](https://en.wikipedia.org/wiki/King_Wen_of_Zhou) and his son, and the composition of the written [**Yì**](https://en.wikipedia.org/wiki/I_Ching) is referred to 'a decaying age,' -- the age, namely, of the tyrant [Yáo](https://en.wikipedia.org/wiki/Emperor_Yao). Then [king Wén](https://en.wikipedia.org/wiki/King_Wen_of_Zhou) and the [duke of Zhōu](https://en.wikipedia.org/wiki/Duke_of_Zhou), it is said, deploring the degeneracy of their times and the enormities of the government, indicated, by their treatment of the ancient symbols, their sense of right and wrong, and the methods by which the prevailing evils might be rectified.
