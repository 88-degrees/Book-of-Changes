...
无妄（䷘ wú wàng）卦的代号是`4:7`卦。主卦是`4`卦，**震**卦，卦象是雷，阳数是`4`，特性是运动，表明主方在积极主动地探索前进。客卦是`7`卦，**乾**卦，卦象是天，阳数是`7`，特性是力量和权威。“妄”（wàng）胡乱，荒诞不合理：轻举妄动。“无妄”，不测，意外。天雷无妄，无妄而得。由于客方力量强大，可能不适当使用权力，给主方造成意想不到麻烦。
